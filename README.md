...
`v0.1.0` — **BUNDLE_FIRST**. This ships as a thin bundle of material moved out of
`canon` (MOVE pattern — canon is no longer the SSOT for these). Full n=6 HEXA-template
authoring of the meta verbs is future work. See [`IMPORTED_FROM_CANON.md`](IMPORTED_FROM_CANON.md).
