...
- `~/core/nexus/shared/bt/bt_keywords.jsonl` — keyword curation (defines breakthrough targets).
- `~/core/nexus/shared/bt/bt_domains.jsonl` — domain mapping.
- `~/core/nexus/shared/bt/bt_audit.hexa` — audit-dedicated.
- `~/core/nexus/shared/bt/bt-*-report` — reports.
- `~/core/nexus/shared/bt/auto_bt.log` — automatic log.
...
**Asset existence**:
- `~/core/nexus/shared/lockdown/lockdown.json` — L0/L1/L2 layer definitions.
- `~/core/nexus/shared/harness/lockdown_gate.hexa` (unified SSOT as of this round, 2026-04-14).
- `~/core/nexus/shared/lockdown/snapshots/` — snapshot directory (untracked, confirmed in state file).
...
- However, `~/core/nexus/shared/engine/cl_refresh_spec.json` and `nexus_cli_spec.json` stand as independent engine specs.
