...
- `~/core/nexus/shared/harness/session_registry.{hexa,jsonl}`
...
**Assets**:
- `~/core/nexus/shared/harness/dream_engine.hexa`
- `~/core/nexus/shared/harness/dream_log.jsonl`
...
**Assets**:
- `~/core/nexus/shared/harness/model_route.hexa`
- `~/core/nexus/shared/harness/model_route.jsonl`
...
- `~/core/nexus/shared/engine/` — all of engine_*.hexa.
...
**Assets**:
- `~/core/nexus/shared/handoff/template.md`
- `~/core/nexus/shared/harness/handoff_write.hexa`
...
**Assets**:
- `~/core/nexus/shared/skills/nexus-status.skill.json`
- `~/core/nexus/shared/skills/registry.json`
...
- `~/core/nexus/shared/hexa-lang/bt-77-port-report.md`
