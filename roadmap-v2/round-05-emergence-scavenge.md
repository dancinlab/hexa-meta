...
- Path: `~/core/canon/bridge/` (CLAUDE.md: "Rust integration workspace (nexus hub repo bridge)").
...
- Path: `~/core/canon/engine/` (CLAUDE.md: "training/math runtime (.hexa)").
- BT: 542 + 544.
- n=6: hexa runtime = SELF-EVO main engine file.
- Self-evolution: YES.

**D203 — canonshared Harness Meta-Field**
- Path: `~/core/canon/canonshared/` (absent — only noted in CLAUDE.md) + `~/core/nexus/shared/harness/` (exists, CLAUDE.md link). **Honesty note**: canon/canonshared is physically linked to nexus/shared. Evidence resides in nexus/shared/harness/.
- BT: 542 + 547.
...
- Evidence: `~/core/hexa-lang/self/bootstrap.hexa` + generic/trait extension (MEMORY `project_hexa_ir_mk1.md`).
- BT: 542.
...
- Evidence: `~/core/anima/anima-physics/memristor/` + Chua 1971 theory.
- BT: 544.
...
- Evidence: `~/core/nexus/shared/bisociation/unified/ouroboros_unified.hexa` (NEXUS_EPSILON=0.001).
...
- Evidence: `~/core/nexus/shared/rules/common.json` R0 "hexa language default" (estimated; common.json content).
...
- Evidence: `~/core/nexus/shared/rules/` + MEMORY `feedback_lockdown_keyword.md` "'nail-it-in' = L0 core lockdown registration".
- BT: 542.
- n=6: L0 = top of 3 layers.
- Self-evolution: YES (L0 file addition procedure).

**D215 — Rule N61 Atlas Promotion Field**
- Evidence: `~/core/nexus/shared/rules/canon.json` (atlas promotion within N61~N65 range).
- BT: 545 + 541.
...
- Evidence: `~/core/canon/experiments/blowup/` + MEMORY `project_blowup_mk2.md`.
- BT: 542 + 543.
- n=6: 6 blowups stage.
- Self-evolution: YES.

**D221 — Experiments Cross-DSE Field**
- Evidence: `~/core/canon/experiments/cross/` + MEMORY `project_millennium_dfs_complete.md` "DFS 5th-cycle loop cross-DSE".
- BT: 542 + 545.
- n=6: cross-DSE 7 BT × 12 buckets = 84 cells.
- Self-evolution: YES.

**D222 — Experiments Lens-Verify Field**
- Evidence: `~/core/canon/experiments/lens-verify/` (distinct from D142: D142 is nexus lenses, D222 is n6-arch experiments/lens-verify).
- BT: 542 + 545.
- n=6: lens verification pipeline.
- Self-evolution: YES.

**D223 — Experiments Structural/Anomaly Field**
- Evidence: `~/core/canon/experiments/structural/` + `anomaly/`.
- BT: 542 + 547.
