...
- `~/core/canon/CLAUDE.md` — top-level rules, 9-axis navigation, atlas section
- `~/core/canon/theory/CLAUDE.md` — theory layer sub-rules
- `~/core/nexus/shared/n6/atlas.n6` — whole-region measurements (106,899 lines, 2026-04-15)
