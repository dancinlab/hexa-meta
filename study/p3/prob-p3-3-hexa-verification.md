...
**Input**: `~/core/nexus/shared/n6/atlas.n6` (SSOT).
...
- HEXA-FIRST principle: `~/core/canon/CLAUDE.md`.
- atlas.n6 SSOT: `~/core/nexus/shared/n6/atlas.n6`, 60K+ lines.
- millennium_scanner.hexa: `~/core/nexus/shared/n6/scripts/millennium_scanner.hexa`, 224 lines.
